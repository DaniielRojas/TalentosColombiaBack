...
class CursosController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $cursos = Cursos::with('docente', 'categoria', 'lecciones', 'comentarios', 'estudiantes')->orderBy('created_at', 'desc')->get();
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            $cursos = Cursos::with('docente', 'categoria', 'lecciones', 'comentarios', 'estudiantes')->orderBy('created_at', 'desc')->findOrFail($id);
